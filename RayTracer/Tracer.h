...
private:
    ...
    bool ProcessSingleRayInModel(ModelObject** model, int modelLength, Vector3D ray, Vector3D rayOrigin, Vector3D* outIntersectPoint, Vector3D *outNormalizedNormal, Vector3D* outReflection, ModelObject* outIntersectedObject);
